...
Configure Server: 
Add a ScriptLauncher server configuration with the host (default: localhost), port (default: 8810), and password
...
Deploy: 
The node will send the command when triggered by an input message
